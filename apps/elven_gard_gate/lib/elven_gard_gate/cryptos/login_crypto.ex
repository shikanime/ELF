defmodule ElvenGardGate.LoginCrypto do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ElvenGardGate.LoginCrypto.encrypt("fail Hello. This is a basic test")
