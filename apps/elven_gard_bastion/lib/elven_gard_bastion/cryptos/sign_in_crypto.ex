defmodule ElvenGardBastion.SignInCrypto do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ElvenGardBastion.SignInCrypto.encrypt("fail Hello. This is a basic test")
