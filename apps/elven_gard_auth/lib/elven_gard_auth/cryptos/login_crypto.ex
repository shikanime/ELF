defmodule ElvenGardAuth.LoginCrypto do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ElvenGardAuth.LoginCrypto.encrypt("fail Hello. This is a basic test")
