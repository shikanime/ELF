defmodule ElvenGardLib.SignInCrypto do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> ElvenGardLib.SignInCrypto.encrypt("fail Hello. This is a basic test")
